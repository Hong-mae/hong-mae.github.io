...
tags:
    ...
    - '2019 카카오 개발자 겨울 인턴쉽'
    - 'Coding Test'
description: '프로그래머스에 있는 2019 카카오 개발자 겨울 인턴쉽 문제 크레인 인형뽑기 게임을 풀어보자.'
socialImage: '/media/crane_game_img.png'
---
...
![crane_game_img.png](/media/crane_game_img.png)
...
![crane_game_102.png](/media/crane_game_102.png)

만약 같은 모양의 인형 두 개가 바구니에 연속해서 쌓이게 되면 두 인형은 터뜨려지면서 바구니에서 사라지게 됩니다. 위 상태에서 이어서 [5번] 위치에서 인형을 집어 바구니에 쌓으면 같은 모양 인형 두 개가 없어집니다.

![crane_game_103.gif](/media/crane_game_103.gif)
...
`gist:Hong-mae/222aa313588e183361cb76af28d42c7a#crane_game_answer.js`

위의 코드를 시각화 하면 다음과 같다.

![crane_game_solve.gif](/media/crane_game_solve.gif)
