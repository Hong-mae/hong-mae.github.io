...
`gist:Moong-bee/f8247b6b3cd4242b07b0e8d6f2b69287#singly_linked_list.c?lines=20-24`

### 기존 노드에 새로운 노드 연결하기

함수 인자로 헤드의 주소값을 받기 때문에 더블 포인터와 값을 받는다.

`gist:Moong-bee/f8247b6b3cd4242b07b0e8d6f2b69287#singly_linked_list.c?lines=26-40&highlights=27-38`
